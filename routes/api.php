...
Route::get('/blogs', [App\Http\Controllers\Api\TypeTreatmentsController::class, 'index']);
Route::get('/blogs/{slug}', [App\Http\Controllers\Api\TypeTreatmentsController::class, 'show']);
